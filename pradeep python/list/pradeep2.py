...
# y=[]
# a=0
# while a<len(                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       vvvvvvvvvvvvnhhhbhbhx):
#     if x[a]==x[-a-1]:
#         y.append(x[a])
#     a+=1
# if x==y:
...
#     if pas in ("a"or"b"or"c"or"d"or"e"or"f"):
#         if pas in ("A"or"B"or"C"or"D"or"E"or"F"):
#             if pas in ("1" or "2" or "3" or "4" or "5" or "6" or "7" or "8"):
#                 if pas in "@":
...
#         if (column==1 or((row==0 or row==3) and column>1 or column<5) or (column ==5 and row !=0 and row<3) or (column ==row-1 and row >2)):
#             result=(result+"*")
#         else:
#             result=(result+" ")
#     result=(result+"\n")
...
# for row in range(0,7):
#     for column in range(0,7):
#         if column==0 or(column == 4 and (row !=0 and row != 3)) or (row!=0 and row!=3 or row >2):
#             print("*",end="")
#         else:
#             print(end=" ")
#     print("\n")
